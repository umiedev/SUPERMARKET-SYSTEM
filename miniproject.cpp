...
m://it is a label which will help us to jump to the main menu
    ...
    case 3:
    {
        exit(0);//it will mark successful termination of the program
        break;
    }
    default:
    {
...
m: //label for goto option
    ...
    case 1:
    {
        ...
        list(); // Display the current list of products
    ...
    case 2:
    {
        cout << "\n\n\t\t\t\t\t\t Current Product List:\n";
        list(); // Display the current list of products
        edit(); // Modify an existing product
        break;
    }
    case 3:
    {
...
void shopping::edit()
{
    ...
    string pkey; //to get the product code from the administrator
    int token = 0;
    string c;
    float p;
    float d;
...
m:
    ...
    string arrc[100]; //we are taking a array to hold the code of the various product
    float arrq[100]; //we are taking a array to hold the quantity of each product
